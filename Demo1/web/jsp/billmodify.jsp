...
<div class="right">
        ...
        <div class="providerAdd">
          <form id="billForm" name="billForm" method="post" action="${pageContext.request.contextPath }/smbms/updateInfo">
                ...
                <div>
                    ...
                    <select id="providerId" name="providerId">
                        <c:if test="${providerList != null }">
                            ...
                            <c:forEach var="role" items="${providerList}">
                                <option <c:if test="${role.id == bill.providerId }">selected="selected"</c:if>
                                        value="${role.id}">${role.proName}</option>
                            </c:forEach>
                        </c:if>
                    </select>
                </div>
                ...
                <div class="providerAddBtn">
				  ...
				  <input type="button" onclick="backto()" id="back" name="back" value="返回" >
              	</div>
            </form>
        </div>
...
<script>
    function backto() {
        window.location.href='${pageContext.request.contextPath }/smbms/user';
    }
</script>
