...
$(function(){
	...
	// $.ajax({
	// 	type:"GET",//请求类型
	// 	url:PageContext+"/user.do",//请求的url
	// 	data:{method:add},//请求参数
	...
	userCode.bind("blur",function(){
		...
		$.ajax({
			type:"GET",//请求类型
			url:PageContext+"/user.do/check",//请求的url
			...
			error:function(data){//当访问时候，404，500 等非200的错误状态码
				validateTip(userCode.next(),{"color":"red"},imgNo+" 您访问的页面不存在",true);
			}
		});
